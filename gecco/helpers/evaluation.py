    ...
    def output(self):
        ...
        if self.modtp:
            ...
            for module in sorted(self.modtp):
                print("Precision for " + module + " : ", round(self.modtp[module] / (self.modtp[module]+self.modfp[module]),2) + "     (" + str(self.modtp[module]) +'/'+ str(self.modtp[module]+self.modtp[module]) + ")" )
            print("")
        if self.clstp:
            print("")
